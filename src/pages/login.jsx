...
import loginIllustration from '../assets/3d-render-secure-login-password-illustration.jpg'
...
const Login = () => {
    ...
    return (
        <div className="flex flex-col bg-white md:flex-row items-center max-w-5xl w-full p-0">
            {/* Login illustration */}
